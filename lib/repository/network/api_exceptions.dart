class ApiException implements Exception {
  ...
  ApiException([this._message, this._prefix, this.code]);
...
class FetchDataException extends ApiException {
  FetchDataException([String? message, code])
      : super(message, "Error Processing Request: ", code);
}
...
class InternalServerException extends ApiException {
  InternalServerException([message, code])
